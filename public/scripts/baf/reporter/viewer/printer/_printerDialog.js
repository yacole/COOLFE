define(["dojo/_base/declare","baf/dijit/Dialog","baf/base/Util","baf/base/Env","dijit/form/RadioButton",
    "baf/dijit/form/Button","baf/dijit/form/TextBox","dijit/layout/ContentPane"],
    function(declare,Dialog,Util,Env,RadioButton,Button,TextBox,ContentPane){
        return declare("",Dialog,{
            ...
            constructor : function(args){
                args.cssFiles = [Util.url.localUrl("reporter/viewer/printer/style.css")];
                args.href  = Util.url.localUrl("reporter/viewer/printer/_printer.html");
